				...
				<div class="box" style="padding: 6px;">
					<div class="row">
						<div class="box-body">
				            ...
				            <!-- /.box-header -->
				            <!-- form start -->
				            <form class="form-horizontal" method="post" action="{{route('accident.store')}}" data-parsley-validate >
				            	{{ csrf_field() }}
				              <div class="box-body">
				              	<div class="form-group{{ $errors->has('datepicker') ? ' has-error' : '' }}">
					                ...
					                <div class="input-group  date col-sm-7">
					                  ...
					                  <input required   data-parsley-errors-container="#vdate" class="form-control pull-right" value="{{ old('datepicker') }}"  id="datepicker" name="datepicker" type="text" >
					                </div>
				                ...
				                <div class="form-group{{ $errors->has('comment') ? ' has-error' : '' }}">
				                  ...
				                  <div class="input-group date col-sm-7">
					                  ...
					                  <textarea required  data-parsley-errors-container="#vcomment"  class="form-control" id="comment" name="comment" placeholder="Comment" rows=3>{{old('comment') }}</textarea>
				                  </div>
				                ...
				                <div class="form-group{{ $errors->has('injury') ? ' has-error' : '' }}">
				                  ...
				                  <div class="input-group date col-sm-7">
					                  ...
					                  <input required type="number" maxlength="5" data-parsley-errors-container="#vinjury"  value="{{old('injury') }}"  class="form-control" id="injury" name="injury" placeholder="Injury People" type='text' />
				                  </div>
				                ...
				                <div class="form-group{{ $errors->has('dead') ? ' has-error' : '' }}">
				                  ...
				                  <div class="input-group date col-sm-7">
					                  ...
					                  <input required type="number" maxlength="5" data-parsley-errors-container="#vdead" value="{{old('dead') }}"  class="form-control" name="dead" id="dead" placeholder="Dead People" type='text' />
				                  </div>
				                  @if ($errors->has('dead'))
					                  <div class="row">
					                  	<div class="col-md-12 text-center help-block">
...
<script>
	...
	function getDistricts(e)
	{
		...
		$.ajax({
		   ...
		   districts.selected=oldDistrict
		})
	}
