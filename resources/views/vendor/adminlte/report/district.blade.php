				        ...
				        <div class="col-md-4 col-sm-6 col-xs-12">
				          <div class="info-box">
				            ...
				            <div class="info-box-content">
				              ...
				              <span id="accidentsprint"><a id="accident" href="/district/1?" target="_blank"><i class="glyphicon glyphicon-print"></i> Print</a></span>
				            </div>
				            <!-- /.info-box-content -->
				          </div>
				          <!-- /.info-box -->
				...
				<div class="box" style="padding: 6px;">
					<div class="box-body">
						<div class="row">
					        ...
					        <div class="col-md-3 col-sm-6 col-xs-12">
					          <div class="info-box bg-aqua">
					            ...
					            <div class="info-box-content">
					              ...
					              <span class="info-box-number" id="cars">{{$cars}} <span id="carsprint"><a style="color:#fff;" href="/district/2?type=1" id="car" target="_blank"><i class="glyphicon glyphicon-print"></i></a></span></span>
					        ...
					        <div class="col-md-3 col-sm-6 col-xs-12">
					          <div class="info-box bg-green">
					            ...
					            <div class="info-box-content">
					              ...
					              <span class="info-box-number" id="motocycle">{{$motocycle}} <span ><a style="color:#fff;" id="moto" href="/district/2?type=2" class="getdate" target="_blank"><i class="glyphicon glyphicon-print"></i></a></span></span>
					        ...
					        <div class="col-md-3 col-sm-6 col-xs-12">
					          <div class="info-box bg-yellow">
					            ...
					            <div class="info-box-content">
					              ...
					              <span class="info-box-number" id="bicycle">{{$bicycle}} <span id=""><a style="color:#fff;" id="bicycle"  href="/district/2?type=3" target="_blank"><i class="glyphicon glyphicon-print"></i></a></span></span>
					        ...
					        <div class="col-md-3">
					        	<a class="btn btn-primary" id="vehicles" href="/district/2?type=4" id="vehicles">Generate  Vehicles Report</a>
						...
						<div class="row">
					        <div class="col-lg-3 col-xs-4">
					          ...
					          <div class="small-box bg-aqua">
					            ...
					            <a  href="/district/3?type=1" target="_blank" id="licence" class="small-box-footer getdate">
					        ...
					        <div class="col-lg-3 col-xs-4">
					          ...
					          <div class="small-box bg-green">
					            ...
					            <a href="/district/3?type=2" target="_blank" id="immatri" class="small-box-footer getdate">
					              Print <i class="fa fa-arrow-circle-right"></i>
					            </a>
					          </div>
					        </div>
					        ...
					        <div class="col-lg-3 col-xs-4">
					          ...
					          <div class="small-box bg-yellow">
					            ...
					            <a href="/district/3?type=3" target="_blank" id="insurence" class="small-box-footer getdate">
					              Print <i class="fa fa-arrow-circle-right"></i>
					            </a>
					          </div>
					        </div>
					         <div class="col-lg-3">
					          <a class="btn btn-primary getdate" id="documents" href="/district/3?type=4">Generate Documents Report</a>
					      </div>
